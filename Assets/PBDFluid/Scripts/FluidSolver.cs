...
namespace PBDFluid
{
    ...
    public class FluidSolver : IDisposable
    {
        ...
        public Moving_sphere_cs _Sphere_cs_;

        public Vector3 GP_Vec;
        public Vector3 Per_vec;
        ...
        public Vector3 gravity_vec = new Vector3(0.0f, -9.81f, 0.0f);
        

        //public Vector3 Per_vec = _Sphere_cs_;
        //public Vector3 Per_vec = new Vector3(1.0f, 0.0f, 1.0f);
        //public Vector3 Per_vec = new Vector3(0.0f, 0.0f, 0.0f);
        ...
        {
            _Sphere_cs_ = GameObject.Find("Sphere_End").GetComponent<Moving_sphere_cs>();

            Per_vec = _Sphere_cs_._dirVector;
            GP_Vec = Per_vec + gravity_vec;
            ...
            m_shader.SetVector("Gravity", GP_Vec);
            Debug.Log(GP_Vec);
